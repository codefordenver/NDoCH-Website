# Code for Denver NDoCH
This website is a single page site for the Code for Denver x Code for Boulder NDoCH event.

The overall template is based off of  [Start Bootstrap - Creative](https://startbootstrap.com/template-overviews/creative/) by **[David Miller](http://davidmiller.io/)**
